...
function CreateTukuiConfigUI()
	...
	TukuiConfigUI:SetScript("OnShow", function(self) UIFrameFadeIn(UIParent, .5, 1, 0) end)
	TukuiConfigUI:SetScript("OnHide", function(self) UIFrameFadeOut(UIParent, .5, 0, 1) end)
end
